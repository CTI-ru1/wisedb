 ...
 */
public class GetLinkReading {

    /**
     * a log4j logger to print messages.
     */
    private static final Logger LOGGER = Logger.getLogger(GetLinkReading.class);
    ...
    public static void main(final String[] args) {
        ...
        final int id = 1;
        try {
            final LinkReading reading = LinkReadingControllerImpl.getInstance().getByID(1);
            if (reading != null) {
